#A Learning Path for Machine Learning: Top-Down Approach for Software Engineers
...
This is my contribution along with many other creators, to help those who want to start on the path of machine learning just like I did some time ago.

The objective of this guide is to help beginners in this amazing yet challenging world by providing tips, showcasing my and other creators' results, presenting facts, and suggesting some paths.
 Follow the least tiring path, but remember that if shortcuts were the best way, they would be called the main road.
...
Reading this guide can be useful for anyone who wants to become a Machine Learning engineer and is looking for a practical, hands-on approach that abstracts most of the math for beginners. The author shares their personal experience as a self-taught mobile app developer who does not have a degree in Computer Science and is therefore looking for an efficient way to prepare for this career. The guide contains a variety of resources and useful information to help readers build their knowledge base in Machine Learning, from books and competitions to communities and podcasts.

Think about  interest in machine learning:
...
## How to use it
To use this guide, follow the outline below and complete each item in order from top to bottom. This guide uses Github's markdown flavor and includes task lists to track your progress.

Create a new branch for your work. You can mark items as completed by placing an "x" inside the brackets, like this: [x].so you can check items like this, just put an x in the brackets: [x]

[More about Github-flavored markdown](https://guides.github.com/features/mastering-markdown/#GitHub-flavored-markdown)


## Don't feel you aren't smart enough
 People feel discouraged when I come across books and courses that assume I already have knowledge in multivariate calculus, inferential statistics, and linear algebra. It can be overwhelming and I'm not sure where to begin.
